...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_qt_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 9, 16)
    },
    "qt\0box2\0\0startButtonClick\0"
};
...
void qt::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->box2(); break;
        case 1: _t->startButtonClick(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject qt::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_qt.data,
      qt_meta_data_qt,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qt.stringdata))
